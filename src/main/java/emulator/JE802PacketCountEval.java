...
import layer3_network.JE802RERRPacket;
import layer3_network.JE802RREPPacket;
import layer3_network.JE802RREQPacket;
...
public class JE802PacketCountEval {
	...
	public void addTransmittedPacket(JE802_11Mpdu aMpdu) {
		JE80211MpduType type = aMpdu.getType();
		switch (type) {
		case ack:
			mpduCounts[0]++;
			break;
